//
//  Gizmo-Pranks-Interaction2-ViewController.swift
//  Eureka Ed
//
...
class Gizmo_Pranks_Interaction2_ViewController: EKDInteractionViewController {
        ...
        if recognizer.state == UIGestureRecognizerState.Ended {
            ...
            if target.pointInside(point, withEvent: nil) {
                ...
                if finished == 4 {
                    ...
                    Flurry.logEvent("Completed 2nd Interaction")
                }
            }
            else {
                block.setTranslatesAutoresizingMaskIntoConstraints(false)
